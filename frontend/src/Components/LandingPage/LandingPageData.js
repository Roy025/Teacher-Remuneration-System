export const homeBlockOne = {
	...
	description:
		'Based on your access level, you have to entry a certain amount of data. All of the infromation are exam related. Be more carefull about your entries if you have a higher level of authorization in the billing section',
...
export const homeBlockTwo = {
	...
	description:
		'Bills that had been issued and the payments already cleared, are listed.',
...
export const homeBlockThree = {
	...
	description:
		'Bills that had been issued and the payments remains uncleared, are listed.',
