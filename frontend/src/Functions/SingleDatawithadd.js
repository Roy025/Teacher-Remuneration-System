...
const SingleDatawithadd = ({ options, propName, index, existingData, setExistingData }) => {
    const [selectedData, setSelectedData] = useState(
        existingData[index] ? existingData[index].map(data => {
            return data.name;
        }) : ""
    )

    useEffect(() => {
        setSelectedData(existingData[index] ? existingData[index].map(data => {
