...
const TermPaperComp = ({
  ...
  const [selectedExaminers, setSelectedExaminers] = useState(
    existingData ? existingData.map((data) => data.examiners) : [[]]
  );
        ...
        return (
          <div className="ParentFormRow" key={index}>
            <div
              ...
              key={index}
            >
              <div className="FormRowNoCrossContainer">
                <div className="FormRowNoCross">
                  <div className="labelFlex firstTermpaperCompElement">
                    <label>Course</label>
              ...
              {existingData.length !== 1 ? (
                <div className="FormRowElement">
                  <button
                    className={`crossButton termpaperCrossButton ${
                      index === 0 && "termpaperCrossButton-first"
                    }`}
